...
--
-- Host: localhost    Database: springstageopdracht
-- ------------------------------------------------------
...
INSERT INTO `user_roles` VALUES (1,'admin','ROLE_ADMIN'),(2,'client','ROLE_CLIENT'),(3,'leader','ROLE_PROJECT_LEADER'),(4,'employee','ROLE_EMPLOYEE'),(5,'Colruyt','ROLE_CLIENT');
